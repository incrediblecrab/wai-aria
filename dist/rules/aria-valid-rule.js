...
exports.AriaValidRule = void 0;
const compliance_engine_1 = require("../core/compliance-engine");
const types_1 = require("../types");
const wcag_rules_1 = require("./wcag-rules");
class AriaValidRule extends compliance_engine_1.BaseRule {
    constructor() {
        super(...arguments);
        this.id = 'aria-valid';
        this.VALID_ARIA_ATTRIBUTES = {
    ...
    validateIdReferences(element, attrName, value, analyzer, violations) {
        if (!value.trim())
            return;
    ...
    checkConflictingAttributes(element, analyzer, violations) {
...
exports.AriaValidRule = AriaValidRule;
//# sourceMappingURL=aria-valid-rule.js.map